...
const Footer = () => {
    return (
        <section>
            <div>
                <footer className="bg-orange-400 text-center text-white dark:bg-neutral-600">
                    <div className="container pt-5 mt-20">
                        <div>
                    ...
                    <div
                        ...
                        © 2023 Copyright:
                        <a
                            className="text-neutral-800 dark:text-neutral-400 underline font-medium"
